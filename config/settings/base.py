...
LANGUAGE_CODE = "en-us"
TIME_ZONE = env("TIME_ZONE", "America/Phoenix")
USE_I18N = True
USE_TZ = True
...
MAX_EXCEL_UNCOMPRESSED_MB = env_int("MAX_EXCEL_UNCOMPRESSED_MB", 50)
MAX_EXCEL_PARSED_ROWS = env_int("MAX_EXCEL_PARSED_ROWS", 5000)
